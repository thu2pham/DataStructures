...
import pytest
from projects.words.words import Stack, Queue, read_file, distance, distance_all
...
class TestWordsMethods:
    ...
    def test_distance_all(self):
        '''Testing distance_all function'''
        #no used words
        word = 'Hello'
        all_words = ['Jello', 'Happy']
        used_words = []
        assert distance_all(word, all_words, used_words) == ['Jello']
        #used words
        word = 'Hello'
        all_words = ['Jello', 'Happy']
        used_words = ['Jello']
        assert distance_all(word, all_words, used_words) == []
